...
any other project-hosted space), and also applies when an individual is officially representing
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported via a GitHub
issue on this repository, or — for anything you'd rather not raise publicly — through the private
reporting channel described in [`SECURITY.md`](SECURITY.md). All complaints will be reviewed and
...
available at [Translations][translations].
